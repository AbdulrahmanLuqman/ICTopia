...
const CompanyService = () => {
    return (
        <div>
            <div className="w-full flex flex-col gap-[3rem] lg:px-[6rem] text-white md:px-[4rem] px-[2rem] py-[3rem] bg-center bg-[url('../src/image/background-factory-verydark.jpg')] bg-no-repeat bg-cover">
