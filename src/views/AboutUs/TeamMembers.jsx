...
const TeamMembers = () => {
  return (
    <div className="w-full h-full bg-[#f2f1ed]">
      <div className="w-full relative px-[6rem] py-[3rem] bg-center bg-[url('../public\images/hero_inner_page.jpg')] bg-no-repeat bg-cover">
        ...
        <div className="relative flex flex-col gap-[0rem] text-[20px] text-white">
          ...
          <h1 className="font-[500] text-[44px]">Team members</h1>
          <p className="text-[20px] pt-[1rem]">Capitalise on low hanging fruit to identify a ballpark value added activity to beta test. Override <br /> the digital divide with additional clickthroughs.</p>
        </div>
      </div>
      ...
      <div className="w-full flex items-center justify-between px-[6rem] py-[1rem] bg-[#54c4cf] text-white text-[20px] font-[600]">
            <p className="">Looking for a First-Class Scientific Partner?</p>
      ...
      <div className="w-full fleX flex-col gap-[1rem] items-center lg:px-[6rem] md:px-[4rem] px-[3rem] lg:py-[8rem] md:py-[5rem] py-[3re,">
        <div className="w-full flex items-center justify-between gap-[2rem]">
          ...
          <div className="w-[50%]"><img src="/images/inner_office_1.jpg" alt="Inner office 1" /></div>
        </div>
        <div className="pt-[2rem] w-full grid lg:grid-rows-1 lg:grid-cols-4 md:grid-rows-2 md:grid-cols-2 gap-x-[2rem] gap-y-[2rem] items-center">
          <div className="w-[100%] h-[70vh] flex flex-col">
            <div className="w-[100%] h-[65%] relative cursor-pointer">
              <div className="absolute w-full h-full z-20  transitionallm duration-300 easineout opacity-0 hover:opacity-100">
                <div className="absolute top-0 left-0 w-full h-full bg-black opacity-30 z-20 w-full"></div>
