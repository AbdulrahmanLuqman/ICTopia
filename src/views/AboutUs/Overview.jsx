...
import ProgressBar from "../../components/AboutUsComponents/ProgressBar";
  ...
  return (
    <div>
      ...
      <div className="grid gap-2 px-5 py-16 md:px-8 lg:px-24">
        <img src={CodeService} alt="" className="w-full md:h-[640px] lg:h-[750px] xl:h-[850px]" />
        ...
        <div>
          <button className=" bg-[#54C4CF] py-3 px-8 text-white font-semibold rounded-md mt-8 lg:px-12">
            OUR SERVICES
          </button>
        </div>
      </div>
