    ...
    <div className="md:tracking-wider lg:tracking-normal">
      <section className="grid lg:grid-cols-4 gap-x-6 gap-y-12 bg-map bg-cover bg-fixed px-7 md:px-14 lg:px-24 py-16   text-white">
        <div className="col-span-1">
          ...
          <p className="text-sm lg:text-xs py-3">
        ...
        <div className="col-span-1">
          ...
          <div className="w-16 bg-blue-400 h-[1px] rounded-lg my-2"></div>
          <p className="text-sm lg:text-xs py-2">
            Be part of the innovation! Stay updated with competition highlights,
            groundbreaking projects, and tech insights <br />
          ...
          <div className="flex gap-2 py-2">
            ...
            <Link
              ...
              target="_blank"
            >
              <FaInstagram className="text-white hover:text-blue-600 bg-blue-600 hover:border hover:border-blue-500 hover:bg-transparent rounded-full p-3 w-10 h-10" />
            </Link>
            <Link
              href="https://www.linkedin.com/company/ictopia/ "
              target="_blank"
            >
          ...
          <div className="grid lg:grid-cols-3 pb-8 gap-20">
            <div className="">
              ...
              <div className="grid grid-cols-2">
                <Link
                  to="/about-us"
                  className="w-fit text-sm py-2 hover:text-blue-400 border-gray-400 border-b-[0.5px]"
                >
                  About us
                </Link>
                <Link
            ...
            <div className="">
              ...
              <button className="text-[10px] text-white bg-blue-500 hover:bg-black rounded-sm px-4 py-[10px] mb-[2px] mr-[2px]">
